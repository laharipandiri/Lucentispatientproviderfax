...
public class New_TC04_HCPPortal_UploadDocument extends HubHomeLoginLogoutPage {
	...
	{		String title = driver.getTitle();
		...
		try {
			...
			//		testData1 = gst.SmokeGetPhysicianNewPageRequiredFields(Key1, rowNum1); //Same method for all Provider
				testData1 = gst.GetPhysicianNewPageRequiredFields1(Key1, rowNum1); //Same method for all Provider
