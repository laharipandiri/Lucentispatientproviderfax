...
public class New_TC01_HCPPortal_UploadDocument extends HubHomeLoginLogoutPage {
	...
	{		String title = driver.getTitle();
		...
		try {
			...
			testData1 = gst.FaxGetPhysicianNewPageRequiredFields(Key, rowNum1); //Same method for all Provider
			...
			eft.SearchByMemberID().sendKeys(testData1.get(1).trim());
			Thread.sleep(2000);
