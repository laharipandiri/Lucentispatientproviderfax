...
// clone the fax  and click on edit/assign fax 
@Listeners(TestNGListner.class)
public class TC02_AdminPortal_AdminCloneAFax extends HubHomeLoginLogoutPage {
	...
	//	System.out.println("Test dat in 2 is:" +testData.get(1));
		...
		Thread.sleep(3000);
//		Assert.assertTrue(ahp.IncomingFaxesClone().isDisplayed());
		ahp.IncomingFaxesClone().click(); //Click on clone button
		Thread.sleep(8000);
