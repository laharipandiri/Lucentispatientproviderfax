...
public class New_TC05_AdminPortal_ACH_AddIncomingFaxAndTreatmentTest extends AdminPortalLoginLogoutPage {
...
//	String Key8 = "PaymentsInBOAfterCheckClear";
	...
	String Key2 = "SearchEnrolledPatient";
	String Key3 = "ACHData";
	String Key4 = "ACHStatusBeforePaymentApproval";
	String Key5 = "ACHPaymentsInBOBeforePaymentApproval";
	String Key6 = "ACHPaymentsInBOAfterPaymentApproval";
	String Key7 = "ACHPaymentsInBOAfterCheckAll";
...
//        reader.setDataInNewRow("e2e", "FaxID", row3, faxID);
	   ...
	   else
	   {
 		...
 		atp.AddFaxInformationAndTreatmentToEnrolledPatients(testData, rowNum, "ACH");
...
//        String Amount=atp.GetTheAmount().getText();
       ...
       String existingRCForAmount1= testData.get(8);
        ...
        int achRowNum = etd.getKeyValuePair(Key3);
...
//        int rowNum8 = etd.getKeyValuePair(Key8);
        ...
        reader.setDataInNewRow("Smoke", "CardID", achRowNum, atp.ShortCardID().getText());
           
      //copy programname value to CTM sheet for payment processing
        reader.setDataInNewRow("Smoke", "ProgramName", achRowNum, atp.ProgramField().getAttribute("value"));
...
//        reader.setDataInNewRow("e2e", "Program", rowNum8, atp.ProgramField().getAttribute("value"));
      ...
      //copy amount value to CTM sheet for payment processing
        String copay = gst.copyValueToDiffRow("ACHData", existingRCForAmount.get(1), existingRCForAmount.get(0), achRowNum, "Amount", "Smoke");
       // String copay = gst.copyValueToDiffRow("CTMData", existingRCForAmount, existingRCForAmount, ctmRowNum, "Amount", "Smoke");
        ...
        reader.setDataInNewRow("Smoke", "Amount", achRowNum, String.valueOf(finalCopay));
      ...
      //  System.out.println("atp.TreatementAddConfirmation().getText() : "+atp.TreatementAddConfirmation().getText());
        ...
        Thread.sleep(5000);
        int numOfRows = ptl.ManualTreatmentInformationTableRows().size();
        for(int i=1; i<=numOfRows; i++)
        {
        	Assert.assertEquals(ptl.MTStatusColLatestRow().getText(), testData.get(15));
        	String claimID = ptl.MTClaimIDColLatestRow().getText();
        	String treatmentID = ptl.MTTreatmentIDColLatestRow().getText();
        	
        	reader.setDataInNewRow("Smoke", "ClaimID", rowNum, claimID);
        	reader.setDataInNewRow("Smoke", "TreatmentID", rowNum, treatmentID);
        	reader.setDataInNewRow("Smoke", "ClaimID", ctmRowNum, claimID);
