...
public class TC04_GKRejectScenarios_SearchPatient extends AdminPortalLoginLogoutPage{
	...
	public void SearchPatient() throws InterruptedException, IOException, AWTException
	{
		...
		Thread.sleep(7000);
		abd.InsuranceReprocessTab().click();
		
		
		yui.UpdateInsuranceInfoInInsuranceTabForGKReject();
		
//		Payer name other, medicare, medicare, 78345737458,878748073, 202-07-07, primary prescription insurance, other, medicare, medicare, medicare, 2021-11-02,564995,medicare
//		yui.InsuranceTabInsuranceCompanyNameDropdown().sendKeys("other");
//		yui.InsuranceCompanyOthers().sendKeys("Medicare");
//		yui.InsuranceTabPayerPlanName().selectByVisibleText("Other");
//		yui.InsurancePlanOthers().sendKeys("Medicare");
//		yui.InsuranceTabInsuranceGroupNumber().sendKeys("634638659638");
//		yui.InsuranceTabInsuranceMemberNumber().sendKeys("36589346956");
//		yui.InsuranceTabInsEffDate().sendKeys("2020-07-07");
//		
//		
