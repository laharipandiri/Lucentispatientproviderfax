...
public class TC07_New_TwoDrug_Upload_Check_All extends TestBase {
	...
	public TC07_New_TwoDrug_Upload_Check_All()
	{
		//super();
	}
...
//			driver.findElement(By.xpath("//h3/a/span")).click();
			...
			Thread.sleep(5000);
			System.out.println("PaymentTextFiles");
			driver.findElement(By.xpath("//*[contains(text(),'PaymentTextFiles/')]")).click();
			Thread.sleep(5000);
			
			System.out.println("Click on Last modified");
...
//			TestBase.classAInstance.logReport("Pass", "Max Accum payment", "Succesfully uploaded  check all file");
//			} else {
//			TestBase.classAInstance.logReport("Fail", "Max Accum payment", "Failed to uploaded  check all file");
//			}
		driver.quit();
