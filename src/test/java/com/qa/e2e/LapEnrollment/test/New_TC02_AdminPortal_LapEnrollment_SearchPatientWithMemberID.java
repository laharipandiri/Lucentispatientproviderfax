...
public class New_TC02_AdminPortal_LapEnrollment_SearchPatientWithMemberID extends AdminPortalLoginLogoutPage{
	...
	public void CloseBrowser(ITestResult result) throws IOException, AWTException {
		if(result.getStatus()== ITestResult.SUCCESS){
			TestBase.classAInstance.logReport("Pass", "Lap Enrollment", "Succesfully verified Lap Enrollment in admin");
			} else {
			TestBase.classAInstance.logReport("Fail", "Lap Enrollment", "Failed to verified Lap Enrollment in admin");
			}
		closeBrowser();
