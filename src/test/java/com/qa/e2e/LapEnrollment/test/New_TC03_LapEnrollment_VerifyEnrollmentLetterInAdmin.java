...
public class New_TC03_LapEnrollment_VerifyEnrollmentLetterInAdmin extends AdminPortalLoginLogoutPage {
	...
	public void CloseBrowser(ITestResult result) throws IOException, AWTException {
		if(result.getStatus()== ITestResult.SUCCESS){
			TestBase.classAInstance.logReport("Pass", "Lap Enrollment", "Succesfully verified Lap Enrollment letter in admin");
			} else {
			TestBase.classAInstance.logReport("Fail", "Lap Enrollment", "Failed to verified Lap Enrollment letter in admin");
			}
		closeBrowser();
