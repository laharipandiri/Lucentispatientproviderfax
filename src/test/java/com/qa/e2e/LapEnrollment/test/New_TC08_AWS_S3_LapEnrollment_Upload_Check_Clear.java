...
public class New_TC08_AWS_S3_LapEnrollment_Upload_Check_Clear extends TestBase {
	...
	public New_TC08_AWS_S3_LapEnrollment_Upload_Check_Clear()
	{
	//	super();
	}
...
//				}
	 ...
	 // {
	  ...
	  //}
		...
		//	Thread.sleep(600000);*/
			...
			if(rst==true)
	        {
	        	TestBase.classAInstance.logReport("Pass","AWS check clear","Succesfully able to add Check clear file");
			}
		   else
		   {
			    TestBase.classAInstance.logReport("Fail","AWS check clear","Failed to add add Check clear file");
		   }	
		    driver.quit();
	...
	public void CloseBrowser(ITestResult result) throws IOException, AWTException {
		if(result.getStatus()== ITestResult.SUCCESS){
			TestBase.classAInstance.logReport("Pass", "Lap Enrollment", "Succesfully uploaded Check clear file for Lap treatment for payment ");
			} else {
			TestBase.classAInstance.logReport("Fail", "Lap Enrollment", "Failed to uploaded Check clear file for Lap treatment for payment ");
			}
		driver.quit();
