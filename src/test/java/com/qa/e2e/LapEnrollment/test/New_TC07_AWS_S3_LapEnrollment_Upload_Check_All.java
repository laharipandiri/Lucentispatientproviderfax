...
public class New_TC07_AWS_S3_LapEnrollment_Upload_Check_All extends TestBase {
	...
	public New_TC07_AWS_S3_LapEnrollment_Upload_Check_All()
	{
		//super();
	}
...
//				driver.findElement(By.xpath("//*[@id='awsc-nav-header']/div[1]/div[2]")).click();
	...
	public void CloseBrowser(ITestResult result) throws IOException, AWTException {
		if(result.getStatus()== ITestResult.SUCCESS){
			TestBase.classAInstance.logReport("Pass", "Lap Enrollment", "Succesfully uploaded Check all file for Lap treatment for payment ");
			} else {
			TestBase.classAInstance.logReport("Fail", "Lap Enrollment", "Failed to uploaded Check all file for Lap treatment for payment ");
			}
		driver.quit();
