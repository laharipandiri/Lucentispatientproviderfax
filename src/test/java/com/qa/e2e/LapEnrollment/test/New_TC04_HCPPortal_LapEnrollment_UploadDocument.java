...
public class New_TC04_HCPPortal_LapEnrollment_UploadDocument extends HubHomeLoginLogoutPage {
	...
	//Regression excel sheet
		String Key = "SmokeUploadDocument";
		String Key1 = "LAPPatientEnrollment";
		String Key2 = "FaxAndTreatment";
	...
	public void HCPUpload() throws IOException, AWTException, InterruptedException
	...
	{		String title = driver.getTitle();
		...
		try {
			...
			gst.setMemberIDInExcel_OtherInsurance(Key2, MemberID, rowNum); //Writing back the member ID in excel
			eft.UploadDocumentLink().click();
			Thread.sleep(10000);
			gst.setMemberIDInExcel(Key, MemberID, rowNum);
			
//			System.out.println("I am above to click Product type");
//			eft.ProductSlection().click(); //Product selection
//			Thread.sleep(1000);
//			
//			eft.ProductSlectionLucentis().click();
//			Thread.sleep(1000);
	...
	public void CloseBrowser(ITestResult result) throws IOException, AWTException {
		if(result.getStatus()== ITestResult.SUCCESS){
			TestBase.classAInstance.logReport("Pass", "Lap Enrollment", "Succesfully uploaded fax for Lap Enrollment");
			} else {
			TestBase.classAInstance.logReport("Fail", "Lap Enrollment", "Failed to uploaded fax Lap Enrollment letter");
			}
		closeBrowser();
