...
public class New_TC05_AdminPortal_LapEnrollment_AddIncomingFaxAndTreatmentTest extends AdminPortalLoginLogoutPage {
	...
	String Key0 = "LAPPatientEnrollment";
	...
	public void CloseBrowser(ITestResult result) throws IOException, AWTException {
		if(result.getStatus()== ITestResult.SUCCESS){
			TestBase.classAInstance.logReport("Pass", "Lap Enrollment", "Succesfully created a treatment for Lap Enrollment ");
			} else {
			TestBase.classAInstance.logReport("Fail", "Lap Enrollment", "Failed to created a treatment for Lap Enrollment");
			}
		closeBrowser();
...
//		String CardID = gst.copyValueToDiffRow(Key0, rcNum.get(1), rcNum.get(0), rowNum, newColName[3], "Smoke");
		...
		String Key1 = "LAPPatientEnrollment";
...
//        reader.setDataInNewRow("e2e", "FaxID", row3, faxID);
	   ...
	   else
	   {
 		...
 		atp.AddFaxInformationAndTreatmentToEnrolledPatients(testData, rowNum, "CTP");
...
//		System.out.println("testdata3 is:" +testData3);
      ...
      //copy amount value to CTM sheet for payment processing
        String copay = gst.copyValueToDiffRow("CTPData", existingRCForAmount.get(1), existingRCForAmount.get(0), ctmRowNum, "Amount", "Smoke");
        System.out.println("copay is:" +copay);
