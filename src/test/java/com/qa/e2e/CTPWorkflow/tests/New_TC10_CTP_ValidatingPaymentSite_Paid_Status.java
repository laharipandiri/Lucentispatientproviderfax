...
public class New_TC10_CTP_ValidatingPaymentSite_Paid_Status extends TestBase {
	...
	public New_TC10_CTP_ValidatingPaymentSite_Paid_Status()
	{
	//	super();
	}
	...
	@Test()
	public void ValidatingPaymentSite_Paid_Status() throws InterruptedException, AWTException 
	...
	{ 
		...
		//	Thread.sleep(250000);
			...
			Thread.sleep(2000);
			driver.findElement(By.xpath("//*[@id='mat-select-0']/div/div[2]")).click(); // Select the Program
			...
			System.out.println("excel data****************************"+excelData.toString());
			   ...
			   if(TotalRows >= 1){
			    		 ...
			    		 
		    		 {
			    		 ...
			    		 if(Member.contains(testData.get(0)) && PayAmount.contains(testData.get(2)) && PaymentStatus.contains("Paid")) 
			    		 {
			    			// driver.findElement(By.xpath("//*[@id='mat-input-2']")).sendKeys(Member);
			    			 ...
			    			 System.out.println("The member Id status is changed to PAID: " +Member);
			    			 Reporter.log("The member Id status is changed to PAID: " +Member);
	...
	System.out.println("Total records validated for paid " + numberofrecordsvalidated);
