...
public class New_TC06_CTM_VerifyClaimStatusAfterTreatmentInAdmin extends AdminPortalLoginLogoutPage {
...
//		String CardID = "";
		...
		try {
				Assert.assertTrue(efe.VerifyStatusAcrossPagesBeforePaymentApprovalInAdminPortal(testData, "CTM"));
		}
		catch(InterruptedException e)
		{
