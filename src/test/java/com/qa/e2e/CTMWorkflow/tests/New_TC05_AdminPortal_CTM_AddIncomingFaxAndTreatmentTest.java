...
public class New_TC05_AdminPortal_CTM_AddIncomingFaxAndTreatmentTest extends AdminPortalLoginLogoutPage {
	...
	public void CloseBrowser(ITestResult result) throws IOException, AWTException {
		if(result.getStatus()== ITestResult.SUCCESS){
			TestBase.classAInstance.logReport("Pass", "E2E CTM Lucentis Enrollment Patient", "Succesfully Created a treament");
			} else {
			TestBase.classAInstance.logReport("Fail", "E2E CTP Lucentis Enrollment Patient", "Failed to Creat a treament");
			}
		closeBrowser();
