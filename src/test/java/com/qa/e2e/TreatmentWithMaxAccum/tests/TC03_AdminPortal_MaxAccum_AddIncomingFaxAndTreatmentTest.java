...
public class TC03_AdminPortal_MaxAccum_AddIncomingFaxAndTreatmentTest extends AdminPortalLoginLogoutPage {
...
//        reader.setDataInNewRow("e2e", "FaxID", row3, faxID);
	   ...
	   else
	   {
 		...
 		atp.MaxAccumAddFaxInformationAndTreatmentToEnrolledPatients(testData, rowNum, "CTP");
