...
public class New_TC01_PatientPortal_GKRejectEnrollment_LucentisEnrollment extends HubHomeLoginLogoutPage {
...
//			eft.PatientPopUpVerification();
			eft.e2eCTPLucentisEnrollmentPatientGKReject();
		} catch (Exception e) {
	...
	public void CloseBrowser(ITestResult result) throws IOException, AWTException {
		if(result.getStatus()== ITestResult.SUCCESS){
			TestBase.classAInstance.logReport("Pass", "GK reject Enrollment", "Succesfully enrolled a patient");
			} else {
			TestBase.classAInstance.logReport("Fail", "GK reject Enrollment", "Failed to enrolled a patient");
			}
		closeBrowser();
