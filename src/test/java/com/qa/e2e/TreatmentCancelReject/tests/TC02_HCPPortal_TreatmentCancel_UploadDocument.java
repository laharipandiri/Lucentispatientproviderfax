...
public class TC02_HCPPortal_TreatmentCancel_UploadDocument extends HubHomeLoginLogoutPage {
...
//			TestBase.classAInstance.logReport("Pass", "E2E CTP Lucentis Enrollment Upload EOB", "Succesfully  Upload EOB");
//			} else {
//			TestBase.classAInstance.logReport("Fail", "E2E CTP Lucentis Enrollment  Upload EOB", "Failed to Upload EOB");
//			}
		closeBrowser();
