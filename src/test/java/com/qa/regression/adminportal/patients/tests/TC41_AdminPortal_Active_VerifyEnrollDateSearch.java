...
public class TC41_AdminPortal_Active_VerifyEnrollDateSearch extends AdminPortalLoginLogoutPage {
	...
	public void VerifyPatientsFindPage_SearchByMemberID_DrugReimbursement() throws IOException, AWTException, InterruptedException
	{
		...
		apps.PatientsFindPageEnrollDateFrom().click();
		apps.EnrollDateToday().click();
		apps.PatientsFindPageEnrollDateTo().click();
		apps.EnrollDateToday().click();
