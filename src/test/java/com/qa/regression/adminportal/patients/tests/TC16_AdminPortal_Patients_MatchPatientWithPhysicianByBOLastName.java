...
public class TC16_AdminPortal_Patients_MatchPatientWithPhysicianByBOLastName extends AdminPortalLoginLogoutPage {
	...
	String Key = "MatchPatientWithPhysicianByBOLastName";
	String Key1 = "PatientProviderTabGridCols";
	String Key2 = "MatchPatientWithPhysicianByBOLastNameForAdminReimbursement";
	String Key3 = "MatchPatientWithPhysicianByBOLastNameForBothDrugReimbursement";
	String Key4 = "MatchPatientWithPhysicianByBOLastNameForBothAdminReimbursement";
	...
	@Test ( description = "Verify ability to match a Physician as primary to a patient by BOLastName in DrugReimbursement")
	public void Verify_Patients_MatchPrimaryPhysician_BOLastName_DrugReimbursement()
	{
...
//		
	...
	@Test ( description = "Verify ability to match a Physician as secondary to a patient by BOLastName in DrugReimbursement" )
	public void Verify_Patients_MatchSecondaryPhysician_BOLastName_DrugReimbursement()
	{
		WebDriverWait wait = new WebDriverWait(driver, 30);
		AdminPortalLogin();
		wait.until(ExpectedConditions.visibilityOf(ahp.PatientsLink()));
