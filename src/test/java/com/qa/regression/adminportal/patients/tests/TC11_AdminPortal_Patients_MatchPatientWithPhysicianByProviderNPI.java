...
public class TC11_AdminPortal_Patients_MatchPatientWithPhysicianByProviderNPI extends AdminPortalLoginLogoutPage {
	...
	String Key = "MatchPatientWithPhysicianByProviderNPI";
	String Key1 = "PatientProviderTabGridCols";
	String Key2 = "MatchPatientWithPhysicianByProviderNPIForAdminReimbursement";
	String Key3 = "MatchPatientWithPhysicianByProviderNPIForBothDrugReimbursement";
	String Key4 = "MatchPatientWithPhysicianByProviderNPIForBothAdminReimbursement";
	...
	@Test ( description = "Verify ability to match a Physician as primary to a patient by ProviderNPI in DrugReimbursement" )
	public void Verify_Patients_MatchPrimaryPhysician_ProviderNPI_DrugReimbursement()
	{
...
//		}
	...
	@Test ( description = "Verify ability to match a Physician as secondary to a patient by ProviderNPI in DrugReimbursement")
	public void Verify_Patients_MatchSecondaryPhysician_ProviderNPI_DrugReimbursement()
	{
		WebDriverWait wait = new WebDriverWait(driver, 30);
		AdminPortalLogin();
		wait.until(ExpectedConditions.visibilityOf(ahp.PatientsLink()));
