...
public class TC13_AdminPortal_Patients_MatchPatientWithPhysicianByGPLastName extends AdminPortalLoginLogoutPage {
	...
	String Key = "MatchPatientWithPhysicianByGPLastName";
	String Key1 = "PatientProviderTabGridCols";
	String Key2 = "MatchPatientWithPhysicianByGPLastNameForAdminReimbursement";
	String Key3 = "MatchPatientWithPhysicianByGPLastNameForBothDrugReimbursement";
	String Key4 = "MatchPatientWithPhysicianByGPLastNameForBothAdminReimbursement";
	...
	@Test ( description = "Verify ability to match a Physician as primary to a patient by GPLastName in DrugReimbursement" )
	public void Verify_Patients_MatchPrimaryPhysician_GPLastName_DrugReimbursement()
	{
...
//		
	...
	@Test ( description = "Verify ability to match a Physician as secondary to a patient by GPLastName in DrugReimbursement" )
	public void Verify_Patients_MatchSecondaryPhysician_GPLastName_DrugReimbursement()
	{
		WebDriverWait wait = new WebDriverWait(driver, 30);
		AdminPortalLogin();
		wait.until(ExpectedConditions.visibilityOf(ahp.PatientsLink()));
