...
public class TC15_AdminPortal_Patients_MatchPatientWithPhysicianByBOName extends AdminPortalLoginLogoutPage {
	...
	String Key = "MatchPatientWithPhysicianByBOName";
	String Key1 = "PatientProviderTabGridCols";
	String Key2 = "MatchPatientWithPhysicianByBONameForAdminReimbursement";
	String Key3 = "MatchPatientWithPhysicianByBONameForBothDrugReimbursement";
	String Key4 = "MatchPatientWithPhysicianByBONameForBothAdminReimbursement";
	...
	@Test ( description = "Verify ability to match a Physician as primary to a patient by BOName in DrugReimbursement" )
	public void Verify_Patients_MatchPrimaryPhysician_BOName_DrugReimbursement()
	{
...
//		
	...
	@Test ( description = "Verify ability to match a Physician as secondary to a patient by BOName in DrugReimbursement" )
	public void Verify_Patients_MatchSecondaryPhysician_BOName_DrugReimbursement()
	{
		WebDriverWait wait = new WebDriverWait(driver, 30);
		AdminPortalLogin();
		wait.until(ExpectedConditions.visibilityOf(ahp.PatientsLink()));
