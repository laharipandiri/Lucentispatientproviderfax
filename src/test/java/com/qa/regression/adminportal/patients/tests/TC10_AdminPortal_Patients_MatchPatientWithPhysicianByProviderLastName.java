...
public class TC10_AdminPortal_Patients_MatchPatientWithPhysicianByProviderLastName extends AdminPortalLoginLogoutPage {
	...
	String Key = "MatchPatientWithPhysicianByProviderLastName";
	String Key1 = "PatientProviderTabGridCols";
	String Key2 = "MatchPatientWithPhysicianByProviderLastNameForAdminReimbursement";
	String Key3 = "MatchPatientWithPhysicianByProviderLastNameForBothDrugReimbursement";
	String Key4 = "MatchPatientWithPhysicianByProviderLastNameForBothAdminReimbursement";
	...
	@Test ( description = "Verify ability to match a Physician as primary to a patient by ProviderLastName in DrugReimbursement" )
	public void Verify_Patients_MatchPrimaryPhysician_ProviderLastName_DrugReimbursement()
	{
...
//		try
//		{
//			//PrimaryPhysician as ProviderType and by ProviderLastName for autosuggest
//			Assert.assertTrue(apm.VerifyAbilityToMatchAndUnlinkPrimaryProviderWithPatient(testData, providertabCols, apm.ProviderLastName(), testData.get(3),testData.get(14)));
//		}
//		catch(InterruptedException e)
//		{
//			
...
//		}
	...
	@Test ( description = "Verify ability to match a Physician as secondary to a patient by ProviderLastName in DrugReimbursement" )
	public void Verify_Patients_MatchSecondaryPhysician_ProviderLastName_DrugReimbursement()
	{
		WebDriverWait wait = new WebDriverWait(driver, 30);
		AdminPortalLogin();
		wait.until(ExpectedConditions.visibilityOf(ahp.PatientsLink()));
...
//		try
//		{
//			//Secondary Physician as ProviderType and by ProviderLastName for autosuggest
//			Assert.assertTrue(apm.VerifyAbilityToMatchAndUnlinkSecondaryPrimaryProviderWithPatient(testData, providertabCols, apm.ProviderLastName(), testData.get(3),testData.get(15)));
//		}
//		catch(InterruptedException e)
//		{
//			
