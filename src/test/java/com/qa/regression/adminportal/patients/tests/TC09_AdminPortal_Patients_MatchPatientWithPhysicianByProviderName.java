...
public class TC09_AdminPortal_Patients_MatchPatientWithPhysicianByProviderName extends AdminPortalLoginLogoutPage {
	...
	String Key = "MatchPatientWithPhysicianByProviderName";
	String Key1 = "PatientProviderTabGridCols";
	String Key2 = "MatchPatientWithPhysicianByProviderNameForAdminReimbursement";
	String Key3 = "MatchPatientWithPhysicianByProviderNameForBothDrugReimbursement";
	String Key4 = "MatchPatientWithPhysicianByProviderNameForBothAdminReimbursement";
	...
	@Test ( description = "Verify ability to match a Physician as primary to a patient by ProviderName in DrugReimbursement" )
	public void Verify_Patients_MatchPrimaryPhysician_ProviderName_DrugReimbursement() throws IOException, AWTException, InterruptedException
	{
...
//		
	...
	@Test ( description = "Verify ability to match a Physician as secondary to a patient by ProviderName in DrugReimbursement" )
	public void Verify_Patients_MatchSecondaryPhysician_ProviderName_DrugReimbursement() throws IOException, AWTException, InterruptedException
	{
		WebDriverWait wait = new WebDriverWait(driver, 30);
		AdminPortalLogin();
		wait.until(ExpectedConditions.visibilityOf(ahp.PatientsLink()));
		...
		List<String> providertabCols = new ArrayList<String>();
		providertabCols = dat.GetPatientProviderTabGridCols(Key1, rowNum);
		System.out.println("Key1 providertabCols data is:" +providertabCols);
