...
public class TC17_AdminPortal_Patients_MatchPatientWithPhysicianByBONPI extends AdminPortalLoginLogoutPage {
	...
	String Key = "MatchPatientWithPhysicianByBONPI";
	String Key1 = "PatientProviderTabGridCols";
	String Key2 = "MatchPatientWithPhysicianByBONPIForAdminReimbursement";
	String Key3 = "MatchPatientWithPhysicianByBONPIForBothDrugReimbursement";
	String Key4 = "MatchPatientWithPhysicianByBONPIForBothAdminReimbursement";
	...
	@Test ( description = "Verify ability to match a Physician as primary to a patient by BONPI in DrugReimbursement" )
	public void Verify_Patients_MatchPrimaryPhysician_BONPI_DrugReimbursement()
	{
...
//		
	...
	@Test ( description = "Verify ability to match a Physician as secondary to a patient by BONPI in DrugReimbursement" )
	public void Verify_Patients_MatchSecondaryPhysician_BONPI_DrugReimbursement()
	{
		WebDriverWait wait = new WebDriverWait(driver, 30);
		AdminPortalLogin();
		wait.until(ExpectedConditions.visibilityOf(ahp.PatientsLink()));
