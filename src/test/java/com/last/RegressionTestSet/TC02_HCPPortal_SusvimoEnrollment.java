...
public class TC02_HCPPortal_SusvimoEnrollment extends HubHomeLoginLogoutPage {
	...
	public void CloseBrowser(ITestResult result) throws IOException, AWTException {
		if(result.getStatus()== ITestResult.SUCCESS){
			TestBase.classAInstance.logReport("Pass", "Susvimo Enrollment", "Succesfully enrolled a patient in Susvimo drug");
			} else {
			TestBase.classAInstance.logReport("Fail", "Susvimo Enrollment", "Failed to enrolled a patient in Susvimo drug");
			}
		closeBrowser();
