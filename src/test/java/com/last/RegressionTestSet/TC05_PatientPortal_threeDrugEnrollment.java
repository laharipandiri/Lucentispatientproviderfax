...
public class TC05_PatientPortal_threeDrugEnrollment extends HubHomeLoginLogoutPage {
	...
	@Test(description = "Sucessful Lucentis enrollment")
...
//			eft.PatientPopUpVerification();
	...
	@Test(description = "Sucessful Susvimo and Ophthamology enrollment")
	public void ThreeDrugEnrollment() throws InterruptedException

	{
		...
		try {
//			eft.PatientPopUpVerification();
			eft.SusvimoOphthalmologyEnrollment();
		} catch (Exception e) {
