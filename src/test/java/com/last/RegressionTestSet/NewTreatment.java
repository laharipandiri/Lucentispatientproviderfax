...
public class NewTreatment extends AdminPortalLoginLogoutPage {
	...
	public void AddIncomingFaxAndTreatment() throws InterruptedException, IOException, AWTException
	{
        ...
        */
        ...
        int ctpRowNum = etd.getKeyValuePair(Key3);
        ...
        reader.setDataInNewRow("Smoke", "CardID", ctpRowNum, atp.ShortCardID().getText());
        
      //copy programname value to CTM sheet for payment processing
        reader.setDataInNewRow("Smoke", "ProgramName", ctpRowNum, atp.ProgramField().getAttribute("value"));
      ...
      //copy amount value to CTM sheet for payment processing
        String copay = gst.copyValueToDiffRow("CTPData", existingRCForAmount.get(1), existingRCForAmount.get(0), ctpRowNum, "Amount", "Smoke");
        double finalCopay = Double.parseDouble(copay)-5.0;
        reader.setDataInNewRow("Smoke", "Amount", ctpRowNum, String.valueOf(finalCopay));
      //  System.out.println("atp.TreatementAddConfirmation().getText() : "+atp.TreatementAddConfirmation().getText());
        ...
        for(int i=1; i<=numOfRows; i++)
        {
        	...
        	reader.setDataInNewRow("Smoke", "ClaimID", ctpRowNum, claimID);
        }
