...
public class AdminPortal_AddIncomingFaxAndTreatmentTest extends AdminPortalLoginLogoutPage {
	...
	*/
        ...
        /*
 		//Lucentis doesnt have card ID hence chnaging to Member ID
        ...
        System.out.println("Testdata in:" +existingRCForAmount);
