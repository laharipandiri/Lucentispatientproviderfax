...
public class AdminPortal_Faxes_OutgoingFindPage extends TestBase {
	
	AdminPortalHomePage ahp = new AdminPortalHomePage(); 
	
	public AdminPortal_Faxes_OutgoingFindPage() {
	...
	public List<WebElement> OutgoingFaxesSearchGridCols()
	{
		return driver.findElements(By.xpath("//*[@id='reportTable']/thead/tr/th"));
	}
	
	public WebElement OutgoingFaxesSearchGridColNames(int i)
	{
